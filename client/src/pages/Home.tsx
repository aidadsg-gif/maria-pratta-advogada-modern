      ...
      <main>
        ...
        <section id="sobre" className="section section--about">
          <div className="container about-grid">
            <div className="about-visual"><img src="/images/foto-maria.webp" alt="Dra. Maria Pratta em ambiente profissional" /><span className="visual-caption">Escuta, estratégia<br />e presença.</span></div>
